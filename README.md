...
|------|--------|----------|------------------|------|-------------|
| 3D Printed Monkey Body | This contains all of the electronics | 1 | 10 | https://github.com/GaiyatriJain/Playful-Linked-Robots | I can get it from my local library, it's 15 cents per gram, and i estimated 50-100 grams (avg 10 dollars) |
